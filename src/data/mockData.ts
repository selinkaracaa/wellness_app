...
export const FRIENDS: Friend[] = [
  { id: 'f1', name: 'Maya', avatar: '🦋', streak: 12, level: 8 },
  { id: 'f2', name: 'Jake', avatar: '🦊', streak: 5, level: 4 },
  { id: 'f3', name: 'Selin', avatar: '🌻', streak: 21, level: 14 },
  { id: 'f4', name: 'Alex', avatar: '🐬', streak: 3, level: 3 },
  { id: 'f5', name: 'Priya', avatar: '🌸', streak: 8, level: 6 },
]
